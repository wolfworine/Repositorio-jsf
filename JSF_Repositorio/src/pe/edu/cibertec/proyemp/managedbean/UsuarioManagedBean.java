...
public class UsuarioManagedBean {
	...
	public String registrar() {
		...
		context.addMessage(null, new FacesMessage(
				"Registro " + usuario.getEmail()+ " ingresado"
				));
		usuario = new Usuario();
		return "/paginas/usuario/mantenimiento.xhtml?faces-redirect=true";
	...
	public String  modificar() {
		...
		login.setPassword(selecUsuario.getPassword());
		login.setEmail(selecUsuario.getEmail());
		login.setPassword(selecUsuario.getPassword());
		usuarioService.getUsuarioRepository().save(selecUsuario);
		loginService.getLoginRepository().update(selecUsuario.getId(),selecUsuario.getPassword(),selecUsuario.getEmail());
		FacesContext context = FacesContext.getCurrentInstance();
		context.addMessage(null, new FacesMessage(
				"Registro " + usuario.getEmail()+ " actualizado"
				));
		return "/paginas/usuario/mantenimiento.xhtml?faces-redirect=true";
	}
