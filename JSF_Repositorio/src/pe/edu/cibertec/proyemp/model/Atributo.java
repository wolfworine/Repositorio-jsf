...
public class Atributo {
	...
	public Atributo(Long id, Long id_rol, Long id_suministro, String parametro,
			String atributo_codigo, String atributo_nombre, String aplicacion) {
		super();
		this.id = id;
		this.id_rol = id_rol;
	...
	public String toString() {
		return "Atributo [id=" + id + ", id_rol=" + id_rol + ", id_suministro="
				+ id_suministro + ", parametro=" + parametro
